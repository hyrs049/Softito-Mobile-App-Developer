...
class DijitalUrun extends Urun {
  ...
  /* Solid ihlali-liskov yerine geçme ilkesi
   liskov yerine geçme metodu:alt sınıfın üst metoddaki sözleşmeyi bozup exception
    fırlatması yüzünden kod tabanında ürün refansı üzerinden bu metot çağırıldığında program çökebilir.
    aşağıdaki sipariş tamamla() metodu sepettki her ürün için metodu çağırıyor;
    ve örnek sepette bir ürün olduğu için kod olduğu gibi çalışırsa exception fırlatıp çöker.
   */
  @override
  double kargoUcretiHesapla() {
...
/*
SOLİD İHLALİ -ISP/arayüz ayrimi ilkesi
arayuz birbiriyle alakasız 6 farklı sorumluluğu; sipariş kaydetme,
odem alma,kargo gönderme,mail atma,sms atma,fatura yazdırma 
  tek bir arayüzde zorluyor.
*/
